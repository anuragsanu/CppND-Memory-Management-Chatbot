...
ChatLogic::ChatLogic(const ChatLogic& chatlogic)
{
    this->_panelDialog = chatlogic._panelDialog;
    for(const auto& i: chatlogic._nodes)
    {
        this->_nodes.emplace_back(new GraphNode(*i));
    }
}
